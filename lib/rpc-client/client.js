...
var proxyCB = function(client, serviceName, methodName, args, attach, isToSpecifiedServer) {
  ...
  if (isToSpecifiedServer) {
    return bb.promisify(rpcToSpecifiedServer)(client, msg, serverType, routeParam, cb);
  } else {
    return bb.promisify(getRouteTarget)(client, serverType, msg, routeParam, function(err, serverId) {
      if (err) {
        return cb(err);
      }
